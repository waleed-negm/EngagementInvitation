...
const imageTween = new TimelineMax()
	.add(TweenMax.fromTo('.myimage', 1, { transform: 'scale(1.5)' }, { transform: 'scale(1)', ease: Linear.Circ }))
	.add(TweenMax.to('.myimage', 1, { ease: Linear.Circ }), 0);
...
new ScrollMagic.Scene({ triggerHook: 0, duration: 2500, tweenChanges: true, triggerElement: '.parallax' }).addIndicators().setTween(tween3).addTo(controller);
//welcome
//pin
new ScrollMagic.Scene({ triggerHook: 0, duration: 2500, tweenChanges: true, triggerElement: '.welcome' }).addIndicators().setPin('.welcome', { pushFollowers: true }).addTo(controller);
//pin hwm
...
//pin footer
new ScrollMagic.Scene({ triggerHook: 0, duration: '100%', tweenChanges: true, triggerElement: '.footer' }).addIndicators().setPin('.footer', { pushFollowers: true }).addTo(controller);
//-----------------------------------------------------------------------------------------------
